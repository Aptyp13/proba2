...
<div class="content">
    <div class="container">
     ...
     <!--   <div class="container">
        ...
        <div class="scroll click-menu-about">
            <a href="#about">
                <i class=" icon-down-open revealator-slideleft revealator-delay14 revealator-once"></i>
            </a>
        </div>
    </div>
</div>
        ...
        <div class="about">
            <div class="container">
                ...
                <div class="icons">
                    ...
                    <div class="icons-block revealator-slideup revealator-delay2 revealator-once">
                        <i class="icon-globe"></i>
                        <h3>Awesome Icons</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor</p>
                    </div>

                    <div class="icons-block revealator-slidedown revealator-delay2 revealator-once">
            ...
            <div class="container">
                ...
                <div id="options">
                    <div id="filters" class="button-group js-radio-button-group">
                        ...
                        <button class="button" data-filter=".transition">ui/ux design</button>
                        <button class="button" data-filter=".nonmetal">mockups</button>
                    </div>
                </div>

                <div class="isotope">
                    <div class="item transition metal">
                        <img src="img/7.png">
                    </div>
                    ...
                    <div class="item noble-gas nonmetal ">
                        <img src="img/5.png">
                    </div>

                    <div class="item diatomic nonmetal ">
                        <img src="img/6.png">
                    </div>
                </div>
                <button class="button is-checked">view all</button>
            </div>
        </div>
    </section>
